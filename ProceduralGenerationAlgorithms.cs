...
public static class Direction2D
{
    ...
    {
        new Vector2Int(0, 1), // Upwards direction.
        new Vector2Int(1, 0), // Right direction.
        new Vector2Int(0, -1), // Downwards direction.
        new Vector2Int(-1, 0) // Left direction.
    };

    public static List<Vector2Int> diagonalDirections = new List<Vector2Int>
    {
        new Vector2Int(1, 1), // Upwards right direction.
        new Vector2Int(1, -1), // Downwards right direction.
        new Vector2Int(-1, -1), // Downwards left direction.
        new Vector2Int(-1, 1) // Upwards left direction.
    };
